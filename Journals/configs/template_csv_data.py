...
sagepub_line = ",,,find|class|loi__issues~find_all|class|loi__issue,True,find|elem|a,find|elem|a,,find|class|loi__issue__cover-date,,find|class|table-of-content,,find_all|class|issue-item__container ,find|class|issue-item__header~find_all|elem|span|2,find|class|issue-item__abstract__content collapse,5,,D"
lww_line = ",,,find|class|AVIssueList~find_all|class|AVIssueLink,True,find|elem|a,find|elem|a,,find|elem|a,,find|class|article-list,,find_all|class|content-box,find|elem|h3,"
