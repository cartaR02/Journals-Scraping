# journal_id,  Journal Name,    url_field,    journal_containers,     landing_page_gathering,   link_data,    headline_data,    headline_formatting_data,   date_data,    date_formatting_data,     journal_data_info,    journal_info_formatting, journal_article, article_tag, abstract link, abstract text,    load_time,    bypass,   status
...
sagepub_line = ",,,find|class|loi__issues~find_all|class|loi__issue,True,find|elem|a,find|elem|a,,find|class|loi__issue__cover-date,,find|class|table-of-content,,find_all|class|issue-item__container,find|class|issue-item__header~find_all|elem|span|2,find|elem|a,find_all|class|core-container|2~find|elem|div,5,True,D"
lww_line = ",,,find|class|AVIssueList~find_all|class|AVIssueLink,True,find|elem|a,find|elem|a,,find|elem|a,,find|class|table-of-content,,find_all|class|issue-item__container ,find|class|issue-item__header~find_all|elem|span|2,find|elem|a,find_all|class|core-container|3~find|elem|div,5,,D"
